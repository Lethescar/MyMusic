	...
	window[fnName] = function(setConfig){
		...
		_this.upMenu = function(){
			...
			for(var i in song){
				...
				inline.append("<li><a href='javascript:;' class='song_title'>"+(song[i].title || '未知歌曲')+"</a><a href='javascript:;' class='song_singer'>"+(song[i].singer || '未知歌曲')+"</a><a href='javascript:;' class='song_duration'>"+(song[i].duration || '未知歌曲')+"</a></li>");
			}
